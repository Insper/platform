...
!!! tip "Spring + Prometheus + Grafana"
    ...
    === "1. pom.xml"
        ...
        ``` { .xml .lineno="1" }
        --8<-- "./docs/2026.1/exercises/bottlenecks/observability/pom.xml"
        ```
    ...
    === "2. application.yaml"
        ...
        ``` { .yaml .lineno="1" }
        --8<-- "./docs/2026.1/exercises/bottlenecks/observability/application.yaml"
        ```
    ...
    === "3. compose.yaml"
        ...
        ``` { .yaml .lineno="1" }
        --8<-- "./docs/2026.1/exercises/bottlenecks/observability/compose.yaml"
        ```
    ...
    === "4. prometheus.yml"
        ...
        ```{ .yaml .lineno="1" }
        --8<-- "./docs/2026.1/exercises/bottlenecks/observability/prometheus.yml"
        ```
    ...
    === "5. Grafana to Prometheus"
        ...
        ```{ .yaml .lineno="1" }
        --8<-- "./docs/2026.1/exercises/bottlenecks/observability/datasources.yml"
        ```
